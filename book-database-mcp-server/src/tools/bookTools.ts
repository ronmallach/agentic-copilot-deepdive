...
import {
  ...
  GetBooksByTitleSchema,
  GetBooksByIsbnListSchema,
  GetBooksByAuthorSchema,
...
Error Handling:
  ...
  server.registerTool(
    'book_database_get_book_by_title',
    {
...
Error Handling:
  ...
  server.registerTool(
    'book_database_get_book_by_isbn',
    {
...
Error Handling:
  ...
  server.registerTool(
    'book_database_get_books_by_titles',
    {
...
Examples:
  ...
  server.registerTool(
    'book_database_get_books_by_isbn_list',
    {
...
Examples:
  ...
  server.registerTool(
    'book_database_get_books_by_author',
    {
